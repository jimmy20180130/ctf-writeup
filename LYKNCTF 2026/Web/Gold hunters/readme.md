...
Looking at the page source, there is this line:

```js
window.API_KEY = "Lp1-QNMM-U3I9FKzwQZq3mVFkZATfzCTOQvTr3h9pbA";
```

I then checked, and found that `/api/openapi.json` contains something:
...
Therefore, I went to `/api/get-flag` and added the header `x-api-key: Lp1-QNMM-U3I9FKzwQZq3mVFkZATfzCTOQvTr3h9pbA` to obtain the flag.
