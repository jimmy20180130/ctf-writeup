...
Using `exiftool`, we can see that the author is `its.fares09`.  
Next, use [this website](https://www.hudsonrock.com/threat-intelligence-cybercrime-tools) to search:

[https://cavalier.hudsonrock.com/api/json/v2/osint-tools/search-by-username?username=its.fares09](https://cavalier.hudsonrock.com/api/json/v2/osint-tools/search-by-username?username=its.fares09)
