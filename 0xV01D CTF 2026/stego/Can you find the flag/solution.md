...
Decoding this gives: `https://www.mediafire.com/file/5xkmnlenyb9kt3h/5E2R/file`. Download the file and you'll find `5E2R`, which is a gzip/tar archive. Using a hex editor, you can see the second half of the flag: `1ng_St3g0_D4mn_WP}` and the first half: `0xV01D{St4rt3d_S0lv`. Combine them together to get the flag
